...
document.getElementById("setOpAdd").innerHTML = "сложение";
document.getElementById("setOpSub").innerHTML = "вычитание";
document.getElementById("setOpMul").innerHTML = "умножение";
document.getElementById("setOpDiv").innerHTML = "деление";
document.getElementById("setOrder").innerHTML = "Порядок";
document.getElementById("setOrderOnes").innerHTML = "единицы";
document.getElementById("setOrderTens").innerHTML = "десятки";
document.getElementById("setOrderTenths").innerHTML = "десятые";
document.getElementById("setFind").innerHTML = "Найти";
document.getElementById("setFindRes").innerHTML = "результат";
document.getElementById("setFindOpd").innerHTML = "операнд";
